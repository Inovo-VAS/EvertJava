 ...
 */
package inovo.json.simple;

import inovo.json.simple.parser.JSONParser;
import inovo.json.simple.parser.ParseException;
...
public class JSONValue {
	 ...
	 * 
	 * @see inovo.json.simple.parser.JSONParser#parse(Reader)
	 * @see #parseWithException(Reader)
	 * 
	 * @param in
	 * @return Instance of the following:
	 *	inovo.json.simple.JSONObject,
	 * 	inovo.json.simple.JSONArray,
	 * 	java.lang.String,
	 * 	java.lang.Number,
	 * 	java.lang.Boolean,
	 * 	null
	 ...
	 * Parse JSON text into java object from the input source.
	 * 
	 * @see inovo.json.simple.parser.JSONParser
	 * 
	 * @param in
	 * @return Instance of the following:
	 * 	inovo.json.simple.JSONObject,
     ...
     * 
     * @see inovo.json.simple.JSONObject#writeJSONString(Map, Writer)
     * @see inovo.json.simple.JSONArray#writeJSONString(List, Writer)
     * 
     * @param value
     * @param writer
     */
	 ...
	 * 
	 * @see inovo.json.simple.JSONObject#toJSONString(Map)
	 * @see inovo.json.simple.JSONArray#toJSONString(List)
	 * 
	 * @param value
