...
import static inovo.asm.Opcodes.ACC_PUBLIC;
import static inovo.asm.Opcodes.ACONST_NULL;
import static inovo.asm.Opcodes.ALOAD;
import static inovo.asm.Opcodes.ARETURN;
import static inovo.asm.Opcodes.ASTORE;
import static inovo.asm.Opcodes.ATHROW;
import static inovo.asm.Opcodes.BIPUSH;
import static inovo.asm.Opcodes.CHECKCAST;
import static inovo.asm.Opcodes.DUP;
import static inovo.asm.Opcodes.F_SAME;
import static inovo.asm.Opcodes.GETFIELD;
import static inovo.asm.Opcodes.ICONST_1;
import static inovo.asm.Opcodes.ICONST_2;
import static inovo.asm.Opcodes.ICONST_3;
import static inovo.asm.Opcodes.ICONST_4;
import static inovo.asm.Opcodes.ICONST_5;
import static inovo.asm.Opcodes.IFEQ;
import static inovo.asm.Opcodes.IFNE;
import static inovo.asm.Opcodes.IFNULL;
import static inovo.asm.Opcodes.IF_ICMPNE;
import static inovo.asm.Opcodes.ILOAD;
import static inovo.asm.Opcodes.INVOKESPECIAL;
import static inovo.asm.Opcodes.INVOKESTATIC;
import static inovo.asm.Opcodes.INVOKEVIRTUAL;
import static inovo.asm.Opcodes.NEW;
import static inovo.asm.Opcodes.PUTFIELD;
import static inovo.asm.Opcodes.RETURN;
import inovo.asm.ClassWriter;
import inovo.asm.Label;
import inovo.asm.MethodVisitor;
import inovo.asm.Opcodes;
import inovo.asm.Type;
import inovo.asm.ex.NoSuchFiledException;
