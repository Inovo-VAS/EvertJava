...
import inovo.presence.utils.pm.queues.PresenceServicesStatusQueue;
...
public class InovoEnvironmentManager extends InovoCoreEnvironmentManager {
	...
	public void initializeServletContext(ServletContext sc) {
		...
		PresenceServicesStatusQueue.initiatePresenceServicesStatusQueue(this.configProperty("PRESENCESERVERIP"));
	}
