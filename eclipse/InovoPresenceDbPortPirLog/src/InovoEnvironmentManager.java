    ...
    this.databaseBulkSourceDestinationTableTransferMonitor=new DatabaseBulkSourceDestinationTableTransferMonitor(Database.dballias("ORACLEPRES"),Database.dballias("MSSQLPRES")){
    	...
    	public String finalSourceTableSqlStatement(String sourceSqlStatement, String sourceTableName,String sourceColumns,String destinationSqlInsertUniqueIndexColumns,
    		...
    		if(sourceTableName.equals("PIR_STARTSTRATEGYLOG")||sourceTableName.equals("PIR_ENDSTRATEGYLOG")){
    			return super.finalSourceTableSqlStatement(sourceSqlStatement, sourceTableName,sourceColumns,destinationSqlInsertUniqueIndexColumns, sourceDbAlias)+" WHERE RDATE<TO_DATE('20170601','YYYYMMDD') ORDER BY RDATE DESC";
    		}
    		else if(sourceTableName.equals("PIR_ENDSTRATEGYLOGDATA")){
    			return super.finalSourceTableSqlStatement(sourceSqlStatement, sourceTableName,sourceColumns,destinationSqlInsertUniqueIndexColumns, sourceDbAlias)+" where STARTSTRATEGYLOGID IN (select ID from PIR_STARTSTRATEGYLOG WHERE RDATE<TO_DATE('20170601','YYYYMMDD')) ORDER BY STARTSTRATEGYLOGID DESC";
    		}
