...
public class FTPDownloader {
	...
	protected void downloadFiles(){
		...
		try{
			Database.executeDBRequest(activefilealliases, "FLATFILELEADSIMPORTER","SELECT [ALLIAS] FROM <DBUSER>.[LEADSDATAFILEALLIAS] WHERE UPPER([ENABLEALLIAS])='TRUE'", null,null);
		...
		Database.cleanupDataset(activefilealliases);
		activefilealliases=null;
		try{
