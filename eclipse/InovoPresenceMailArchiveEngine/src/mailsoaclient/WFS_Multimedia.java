...
public class WFS_Multimedia
{
  ...
  public void addMetaData(String channel, String contactId, String customerIDNumber, String emailAddress, Date emailDate, String emailSubjectLine, String documentType)
  {
    ...
    //this.logger.debug
    log_debug("Setting metadata [contactId=" + contactId + 
  ...
  public String requestArchive(String url)
  {
    ...
    try {
      if ((this.mailObjin != null) && (this.metaData != null))
      {
        ...
        //this.logger.debug(
        log_debug("Requesting archive to " + url);
        ...
        //this.logger.debug
        log_debug("Setting mail export meta data !");
        ...
        //this.logger.debug
        log_debug("Request the actual mail archive.");
        MailExportResponseObjectout returnParam=port.requestSendMultiMediaMsg(this.mailObjin);

        //MailExportResponseObjectout returnParam = port.requestSendMultiMediaMsg(this.mailObjin);
        //this.logger.debug
        log_debug("Return from service [" + returnParam.getCode() + "] - [" + returnParam.getMessage() + "]");
        return "[" + returnParam.getCode() + "][" + returnParam.getMessage() + "]";
      }
    } catch (MalformedURLException e) {
      //this.logger.debug
    	log_debug("MalformedURLException : " + e.getMessage());
      System.out.println("MalformedURLException : " + e.getMessage());
      return "ERROR:URL:" + e.getMessage();
    } catch (ServiceException e) {
      //this.logger.debug
    	log_debug("ServiceException : " + e.getMessage());
      System.out.println("ServiceException : " + e.getMessage());
      return "ERROR:SERVICE - " + e.getMessage();
    } catch (RemoteException e) {
      StackTraceElement[] stack = e.getStackTrace();
      //this.logger.debug
      log_debug("RemoteException : " + e.getMessage());
      for (StackTraceElement stackTraceElement : stack) {
        //this.logger.debug
    	  log_debug("Stack trace element : " + stackTraceElement);
      }
