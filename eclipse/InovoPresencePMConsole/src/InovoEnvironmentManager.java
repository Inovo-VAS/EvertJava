...
import inovo.presence.pmconsole.PMConsoleServiceQueue;
...
public class InovoEnvironmentManager extends InovoCoreEnvironmentManager {
	...
	public void initializeServletContext(ServletContext sc) {
		...
		PMConsoleServiceQueue.pmConsoleServiceQueue();//.registerPMApp("192.168.1.62:6800", "SERVER",1);
	}
		
	@Override
	public void disposeServletContext(ServletContext sc) {
		PMConsoleServiceQueue.pmConsoleServiceQueue().shutdownQueue();
